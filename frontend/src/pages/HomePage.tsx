...
import {
  ...
  formatBytes,
  usePhoton,
} from "../features/home/usePhotonDemo";
    ...
    <div className="relative flex h-screen w-full justify-center overflow-hidden"
      ...
      <div className="flex w-full max-w-[760px] flex-col px-6 pt-[6vh] pb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[17px]" style={{ fontWeight: 500 }}>Photon</span>
        </div>
        ...
        <div className="mt-5">
          ...
          >
            One image,
            <br />
            <em style={{ fontStyle: "italic", color: ACCENT, fontWeight: 300 }}>every variant</em>
